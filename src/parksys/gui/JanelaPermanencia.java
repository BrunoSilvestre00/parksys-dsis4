...
public class JanelaPermanencia extends JFrame{
	...
	private void gerarGrafico() {
	    ...
	    SwingWorker<Void, Void> worker = new SwingWorker<>() {
			...
			protected Void doInBackground() throws ParseException, DataAccessException {
			    ...
			    XYChart chart = new GraficoPermanencia().buildChart(dt1, dt2);
	...
	private void ajustarJanela() {  
		...
		this.setTitle("Gráfico de permanência");
		this.pack();
